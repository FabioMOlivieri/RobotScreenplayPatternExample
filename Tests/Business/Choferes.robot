...
*** Variables ***
${FilePathPruebaPost}    ../../External Resources/Business/Choferes/PruebaPost.json
${FilePathPrueba}    ../../External Resources/Business/Choferes/Prueba.json
${FilePathPruebaComp}    ../../External Resources/Business/Choferes/PruebaComp.json
${FilePathPruebaRodHab}    ../../External Resources/Business/Choferes/PruebaRodriguezHabilitados.json

*** Test Cases ***
GetChofer
    ############# Crear sesión ################
    Create Session    mySession    ${gApiUrlUat}
    ############# setear autenticación en el header ####################
    ${headers}=    Create Dictionary    Authorization=${gAutToken}
    ################ invocar método GET #####################
...
CompRespMultiple
    Create Session    mySession    ${gApiUrlUat}
    ${headers}=    Create Dictionary    Content-Type=application/json; charset=utf-8    Authorization=${gAutToken}
